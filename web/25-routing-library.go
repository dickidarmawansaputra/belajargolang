...
func main() {
	// Routing Library
	/*
		● Walaupun Go-Lang sudah menyediakan ServeMux sebagai handler yang bisa menghandle
		beberapa endpoint atau istilahnya adalah routing
		● Tapi kebanyakan programmer Go-Lang biasanya akan menggunakan library untuk melakukan
		routing
